...
if __name__ == "__main__":
    ...
    "medications": "no",
    "recent_changes": "getting more and more dry",
    "additional_symptoms": "High fever, fatigue, weight loss, night sweats, joint pain",
    "previous_treatments": "put some cream and serums",
    "impact": "affecting daily activities, work, and quality of life",
    "family_history": "Father had SLE, mother had type 1 diabetes"
}
    
    result = run_dermatology_consultation(complex_case)
